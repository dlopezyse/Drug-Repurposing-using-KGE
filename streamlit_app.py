...
if nav == 'Get drugs recommendations :pill:':
    ...
    model_selection = st.selectbox("Select an embedding model", ["TransE", "TransR", "TransH", "UM", "DistMult", "RESCAL", "ERMLP"],
                                  help='Knowledge graph embedding techniques can encode biological information in a single mathematical space. This project is focused on seven embedding models (TransE, TransR, TransH, UM, DistMult, RESCAL, and ERMLP), which can be extended to additional ones.')
